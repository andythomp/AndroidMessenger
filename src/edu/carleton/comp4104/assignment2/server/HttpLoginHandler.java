...
public class HttpLoginHandler implements EventHandler {
	...
	public void handleEvent(Event event) throws IOException {
		...
		try{
			...
			//Otherwise that user already exists
				...
				HttpConnector connector = new HttpConnector(host, acceptor.getConnectorPort());
				Message m = new Message(Message.ERROR);
				m.setHeader(Message.POST + " " + Message.ERROR + " " + Message.HTTP);
